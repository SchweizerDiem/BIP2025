...
// Draw sprites
var spr = asset_get_index("spr_item_" + item);
...
// Draw player's money
draw_text(guiWidth/2 + 50, guiHeight - 25, "Money: " + string(global.money));

// Draw price
draw_set_halign(fa_center);
	draw_text(menuMargin + menuWidth + 54, guiHeight - 25, "Price: " + string(price));
	
	draw_set_valign(fa_right);
		draw_text(guiWidth - 80, guiHeight - 4, "Hit enter to buy");
	draw_set_valign(fa_left);
